...
% Title Page
\title{BUZZ LLC}
\author{Ucizi M. Mafeni\\DU ID: nbgt74}
\date{\today}
\summary{Business plan based on the idea of Seminar group 5-1 \\(Ucizi Mafeni, Karan Argawal and Oliver Robely)}
%%%%%%%%%%%%%%%
...
\begin{figure}[!h]
    ...
    \caption{Our New Venture Typology (REF)}
    \label{fig:nv type}
\end{figure}

For our business, we will adopt a freemium model. Making the app free-to-download helps us maximise on potential downloads, as about 66\% of all mobile users never pay for apps (eMarketer, 2015). This aids our primary objective of growing a big enough user base to ensure profitable amounts of daily activity.
...
\begin{figure}
    ...
    \caption{Business Model Canvas, (Osterwalder and Pigneur, 2009)}
    \label{fig:bmc}
\end{figure}
...
\begin{figure}
    ...
    \caption{PESTLE analysis, Information References:}
    \label{fig:pestle}
\end{figure}
...
\begin{figure}
    ...
    \caption{Porter’s Five Forces (Burns, 2014)}
    \label{fig:porters}
\end{figure}
...
\begin{figure}
    ...
    \caption{Our main competitors, References: Alyson (2015), Mamiit (2015),Engadget(2015)
}
...
Critical Mass is commonly used term in the app industry. It’s essentially “the minimum size of the user base at which enough number of producers and consumers exist to spark transactions sustainably" (Choudhury, 2015). Our aim is to hit an estimated critical mass of 50,000 thousand users within the first three years of operation. Within our target market (UK University Students) this objective should be achievable. 
